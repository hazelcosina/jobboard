...
public class NotificationFactory {
    ...
    public static String buildNotificationContent(Position position) {
        ...
        contentBuilder.append("        <a href=\"http://localhost:8080/status?positionId="+position.getId()+"&status=APPROVED\" style=\"display: inline-block; padding: 10px 20px; text-align: center; text-decoration: none; background-color: #4CAF50; color: black; border: none; border-radius: 5px; cursor: pointer;\">Approve</a>\n");
        contentBuilder.append("        <a href=\"http://localhost:8080/status?positionId="+position.getId()+"&status=REJECTED\" style=\"display: inline-block; padding: 10px 20px; text-align: center; text-decoration: none; background-color: #FF5733; color: black; border: none; border-radius: 5px; cursor: pointer;\">Reject</a>\n");
        contentBuilder.append("    </div>\n");
